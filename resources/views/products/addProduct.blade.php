        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                <div class="p-6 border-b border-gray-200">
                    <form action="{{ route('products.add') }}" method="GET" class="flex items-center space-x-4">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse ($products as $product)
                                <tr class="hover:bg-gray-50 transition-colors duration-200">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <form action="{{ route('products.updateProduct', $product) }}" method="POST"
                                ...
                                <tr>
                                    <td colspan="4"
                                        ...
                                        <div class="flex flex-col items-center py-6">
                                            ...
                                            <p class="text-gray-600">No products found matching your search criteria.
                                            </p>
                                        </div>
                                    </td>
                                </tr>
